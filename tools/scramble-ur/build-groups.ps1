...
$groups = @(
    ...
    @{ index='12'; name='P组棱练习'; formula='U'' D R U2 D2 L'' U'' D'; codes=@('PQ','PR','PS','PT','PW','PX','PY','PZ') }
    @{ index='13'; name='Q组棱练习'; formula='D R'' U2 F2 D2 L'' U D L2 U'; codes=@('QS','QT','QW','QX','QY','QZ') }
