...
<div class="ur-dash">
  <div class="ur-dash__head">
    ...
    <span class="ur-dash__std">浮动标准（每式均速 · 全部已练组平均） <b id="ur-std-value">--</b></span>
  </div>
  ...
  <div class="ur-legend">
    ...
    <span class="ur-legend__item" style="margin-left:auto">偏离条：中线=每式均速标准 · 向左更快 · 向右更慢</span>
  </div>
</div>
...
<div class="ur-controls">
  <span class="ur-controls__group">
    <label for="ur-window">成绩口径</label>
    <select id="ur-window">
...
<div class="ur-detail" id="ur-detail">
  <div class="ur-detail__head">
    <span class="ur-detail__title">平均成绩明细</span>
    <span class="ur-detail__hint" id="ur-detail-hint">浮动标准 --</span>
  </div>
  <div class="ur-detail__row d-head">
    <span>组</span>
    <span>总均</span>
    <span>每式</span>
    <span>偏离标准</span>
